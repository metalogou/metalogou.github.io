...
<details><summary markdown='span'> 6.52  
We feel that even if *all possible* scientific questions be answered, the problems of life have still not been touched at all. Of course there is then no question left, and just this is the answer. </summary><blockquote>
...
He must surmount these propositions; then he sees the world rightly. </text>
