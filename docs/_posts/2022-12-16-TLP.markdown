...
<details><summary markdown='span'> 1 The world is *everything* that is the case. </summary>
...
<details><summary markdown='span'> 1.2 The world *divides* into facts. </summary>

1.21 Any one can either be the case or not be the case, and *everything* else remain the same.

<details><summary markdown='span'> 1.22 He never *said* this. </summary>

1.221 Or *this*.
 
1.222 Or *this*.

<details><summary markdown='span'> 1.223 Or *this*. </summary>
